...
from utils import np, Car, Ball, BoostPad, a3l, a3r, a3v, orient_matrix, turn_r
...
def process(self, packet):
    ...
    dtype = [('physics', [('location', '<f4', 3), ('rotation', [('pitch', '<f4'), ('yaw', '<f4'), ('roll', '<f4')]), ('velocity', '<f4', 3), ('angular_velocity', '<f4', 3)]), ('game_seconds', '<f4')]
    self.ball_prediction = np.ctypeslib.as_array(ball_prediction_struct.slices).view(dtype)[:ball_prediction_struct.num_slices]
